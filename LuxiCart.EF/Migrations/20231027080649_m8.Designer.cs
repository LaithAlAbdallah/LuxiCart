...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuxiCart.EF.Models.ProductSize", b =>
                {
            ...
            modelBuilder.Entity("ProductItemProductSize", b =>
                {
                    b.Property<int>("productItemsProductItemId")
                        .HasColumnType("int");

                    b.Property<int>("productSizesProductSizeId")
                        .HasColumnType("int");

                    b.HasKey("productItemsProductItemId", "productSizesProductSizeId");

                    b.HasIndex("productSizesProductSizeId");

                    b.ToTable("ProductItemProductSize");
                });
            ...
            modelBuilder.Entity("ProductItemProductSize", b =>
                {
                    b.HasOne("LuxiCart.EF.Models.ProductItem", null)
                        .WithMany()
                        .HasForeignKey("productItemsProductItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LuxiCart.EF.Models.ProductSize", null)
                        .WithMany()
                        .HasForeignKey("productSizesProductSizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
